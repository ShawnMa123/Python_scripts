...
def calculate_dca_returns(ticker, start_date, end_date, quarterly_investment, transaction_fee):
    """
    Calculates and plots the returns of a Dollar-Cost Averaging (DCA) investment strategy,
    including yearly and total returns, with quarterly investments.
    ...
    Args:
        ...
        quarterly_investment (float): The amount to invest each quarter.
    ...
    investment_dates = pd.date_range(start=start_date, end=end_date, freq='Q')  # Quarterly investment dates
    ...
    for date in investment_dates:
        available_investment = quarterly_investment - transaction_fee
        ...
        net_investment.append(sum(net_investment) + quarterly_investment if net_investment else quarterly_investment) # Correct net investment calculation
    ...
    yearly_returns['YearlyReturnRate'] = (yearly_returns['YearlyReturn'] / (
                yearly_returns['StartingValue'] + yearly_returns['YearlyInvested']).fillna(1)) * 100
...
# Example usage (assuming quarterly investment of $200):
ticker = 'HSBC'
start_date = '2015-01-01'
end_date = '2024-11-23'
quarterly_investment = 200
transaction_fee = 0.35

yearly_returns_df = calculate_dca_returns(ticker, start_date, end_date, quarterly_investment, transaction_fee)
